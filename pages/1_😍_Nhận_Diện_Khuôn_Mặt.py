...
def run_face_recognition_app():
    ...
    if 'frame_stop' not in st.session_state:
        frame_stop = cv.imread('pages/utility/NhanDangKhuonMat_Streamlit/stop.png')
    ...
    recognizer = cv.FaceRecognizerSF.create(
        'pages/utility/NhanDangKhuonMat_Streamlit/face_recognition_sface_2021dec.onnx', "")
