...
def run():
    ...
    if 'is_load' not in st.session_state:
        # load model
        model_architecture = f"{os.path.dirname(__file__)}/utility/NhanDienChuSo_Streamlit/digit_config.json"
        model_weights = f"{os.path.dirname(__file__)}/utility/NhanDienChuSo_Streamlit/digit_weight.h5"
